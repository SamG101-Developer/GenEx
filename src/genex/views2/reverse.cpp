...
namespace genex::views::detail::impl {
    ...
    struct reverse_iterator {
        ...
        GENEX_INLINE constexpr explicit reverse_iterator(I first, S last) :
        ...
        GENEX_INLINE friend constexpr auto operator-(reverse_iterator const &self, reverse_iterator const &that) -> difference_type requires std::random_access_iterator<I> {
            return self.it - that.it;
        }
    };
    ...
    struct reverse_view {
        ...
        template <typename Self>
        GENEX_ITER_BEGIN {
            return reverse_iterator<I, S>(self.st, self.it);
        }

        template <typename Self>
        GENEX_ITER_END {
            return reverse_iterator<I, S>(self.it, self.st);
        }
