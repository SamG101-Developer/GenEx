...
namespace genex::meta {
  ...
  public:
    ...
    GENEX_INLINE constexpr auto operator=(box &&that) noexcept(std::is_nothrow_move_constructible_v<T>) -> box& requires
...
namespace genex::meta {
  ...
  struct not_impl_fn {
    ...
    GENEX_INLINE constexpr auto operator()(Args &&... args) const -> bool {
