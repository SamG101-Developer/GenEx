...
namespace genex::views {
  struct replace_fn {
    ...
    SAFE_MOVE (I) and SAFE_MOVE(S) and SAFE_MOVE
    (Old) and SAFE_MOVE(New) and SAFE_MOVE
    (Proj)
    )
 {
    ...
    SAFE_MOVE (Rng) and SAFE_MOVE(Old) and SAFE_MOVE
    (New) and SAFE_MOVE(Proj)
    )
 {
    ...
    range<Old>
      ...
      SAFE_CTOR(replace_fn) and SAFE_MOVE
    (Old) and SAFE_MOVE(New) and SAFE_MOVE
    (Proj)
    )
 {
