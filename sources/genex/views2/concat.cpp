...
namespace genex::views::detail::impl {
  ...
  struct concat_iterator {
    ...
    template <typename Self>
    GENEX_INLINE constexpr auto operator+=(this Self &&self, difference_type n) -> concat_iterator& requires (
    ...
    template <typename Self>
    GENEX_INLINE constexpr auto operator+(this Self &&self, concat_iterator const &that) -> difference_type requires (
      random_access_range<Rngs> && ...) {
  ...
  private:
    ...
    template <std::size_t I, typename Self>
    GENEX_INLINE constexpr auto add_impl(this Self &&self, difference_type n) -> void requires (random_access_range<
      Rngs> && ...) {
    ...
    template <std::size_t I, typename Self>
    GENEX_INLINE constexpr auto sub_impl(this Self &&self, difference_type n) -> void requires (random_access_range<
      Rngs> && ...) {
