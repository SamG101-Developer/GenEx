...
namespace genex::views {
    ...
    )
 {
    ...
    SAFE_MOVE (Pred) and SAFE_MOVE(New) and SAFE_MOVE
    (Proj)
    )
 {
    ...
    range<Pred>
      ...
      SAFE_CTOR(replace_if_fn) and SAFE_MOVE
    (Pred) and SAFE_MOVE(New) and SAFE_MOVE
    (Proj)
    )
 {
