...
namespace genex::algorithms::concepts {
    ...
    concept can_none_of_range =
        input_range<Rng> and
        can_none_of_iters<iterator_t<Rng>, sentinel_t<Rng>, Pred, Proj>;
}


namespace genex::algorithms {
    DEFINE_ALGORITHM(none_of) {
        template <typename I, typename S, typename Pred, typename Proj = meta::identity> requires concepts::can_none_of_iters<I, S, Pred, Proj>
        ...
        template <typename Rng, typename Pred, typename Proj = meta::identity> requires concepts::can_none_of_range<Rng, Pred, Proj>
