...
namespace genex::views {
    ...
    struct set_algorithm_unsorted_base_fn {
        ...
        requires detail::concepts::set_algorithmicable_iters<I1, S1, I2, S2, operations::eq, Proj1, Proj2>
        ...
        requires detail::concepts::set_algorithmicable_range<Rng1, Rng2, operations::eq, Proj1, Proj2>
